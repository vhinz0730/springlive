                    ...
                    <tr class="bg-indigo-200 dark:bg-transparent">
                        ...
                        <td class="px-6 py-4 text-black">
                            @if($project->webdev_renewaldate)
                                <span class="relative mt-1.5 flex">
                                    <span class="{{$webdev_month <= $current_month && $webdev_year <= $current_year ? 'block text-white bg-red-800' : 'hidden'}} form-input peer w-full rounded-lg border border-slate-300 px-3 py-2 pl-9 placeholder:text-black hover:border-black">
                        ...
                        <td class="px-6 py-4 text-black">
                            @if($project->seo_renewaldate)
                                <span class="relative mt-1.5 flex">
                                    <span class="{{$seo_month <= $current_month && $seo_year <= $current_year ? 'block text-white bg-red-800' : 'hidden'}} form-input peer w-full rounded-lg border border-slate-300 px-3 py-2 pl-9 placeholder:text-black hover:border-black">
                        ...
                        <td class="px-6 py-4 text-black">
                            @if($project->smm_renewaldate)
                                <span class="relative mt-1.5 flex">
                                    <span class="{{$smm_month <= $current_month && $smm_year <= $current_year ? 'block text-white bg-red-800' : 'hidden'}} form-input peer w-full rounded-lg border border-slate-300 px-3 py-2 pl-9 placeholder:text-black hover:border-black">
